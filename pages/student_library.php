...
<body>
    ...
    <div class="landbox">
    <h3>reserve and meet with your classmates for Educational success! </h3>
    <button class="back" ><a type="button" href="../pages/student_page.php">Back</a></button>
    </div>
        <form id="bookingForm" action="student_library.php" method="POST">
            ...
            <select id="duration" name="duration" required>
                ...
                <option value="90">1h and 30min</option>
